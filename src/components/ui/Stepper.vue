      ...
      <div class="min-w-max mx-auto">
        ...
        <div class="flex items-center">
          <template v-for="(step, i) in steps" :key="'c'+i">
            ...
            >
              <svg v-if="i < activeStep" class="w-[14px] h-[14px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
        ...
        <div class="flex items-start">
          <template v-for="(step, i) in steps" :key="'l'+i">
            <div class="flex-shrink-0 w-[28px] sm:w-[32px] flex justify-center">
              <span
                :class="['mt-[6px] text-[11px] sm:text-[12px] font-medium whitespace-nowrap text-center', i <= activeStep ? 'text-content-primary' : 'text-content-tertiary']"
