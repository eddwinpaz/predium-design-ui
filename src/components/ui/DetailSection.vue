...
<template>
  <div>
    ...
    <div class="flex items-center justify-between mb-[12px]">
      <h3 class="text-[15px] font-semibold text-content-primary">
        {{ title }}
      </h3>
      <button
        v-if="editable"
    ...
    <div class="border border-border rounded-[12px] bg-surface">
      ...
      <div
        v-if="fields?.length"
        :class="[
          'grid gap-0 px-[16px] sm:px-[24px] py-[16px] sm:py-[20px]',
          gridClass,
        ]"
      >
        <div
        ...
        >
          <div
            class="text-[11px] font-medium text-content-tertiary uppercase tracking-[0.5px] leading-[16px] truncate"
          >
            {{ field.label }}
          </div>
          <div
            class="text-[14px] text-content-primary leading-[20px] mt-[2px] break-words"
          >
            {{ field.value }}
          </div>
        </div>
