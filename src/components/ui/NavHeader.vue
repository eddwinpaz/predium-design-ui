...
function getColor(item: ModuleItem, groupIdx: number, itemIdx: number): string {
  return (
    item.color ||
    defaultColors[(groupIdx * 4 + itemIdx) % defaultColors.length] ||
    "#276EF1"
  );
}
</script>
...
<template>
  <div class="relative z-[9999]">
    ...
    >
      ...
      <div class="flex items-center gap-[4px]">
        ...
        <div class="relative">
          ...
          <!-- Desktop-only floating modules panel -->
          <Transition
              ...
              <div class="px-[20px] pb-[20px]">
                <div class="grid grid-cols-2 gap-[24px]">
                  <div v-for="(group, gi) in modules" :key="group.title">
                    <div class="mb-[10px]">
                      <span
                        class="text-[11px] font-semibold text-content-tertiary uppercase tracking-[1px]"
                        >{{ group.title }}</span
                      >
                    </div>
                    <div class="flex flex-col gap-[2px]">
                      ...
                      >
                        ...
                        <span
                          class="text-[13px] font-medium text-content-primary"
                          >{{ item.label }}</span
                        >
                      </button>
                    </div>
    ...
    <!-- Mobile drawer: hamburger nav items -->
    <Transition
      enter-active-class="transition duration-150 ease-out"
    ...
    <!-- Mobile drawer: module items (identical structure to hamburger drawer) -->
    <Transition
      enter-active-class="transition duration-150 ease-out"
      enter-from-class="opacity-0 -translate-y-2"
      enter-to-class="opacity-100 translate-y-0"
    ...
    <!-- Desktop backdrop for grid panel -->
    <div
      v-if="gridOpen"
