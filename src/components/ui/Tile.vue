...
<template>
  <button
    ...
    :class="[
      ...
      disabled
        ? 'opacity-40 cursor-not-allowed hover:border-border hover:shadow-none'
        : '',
  ...
  >
    ...
    <div
      :class="[
        'p-[14px] sm:p-[20px] md:p-[24px] w-full',
    ...
    >
      ...
      <!-- Title -->
      <div
        class="text-[14px] sm:text-[16px] font-semibold text-content-primary leading-[20px] sm:leading-[24px] pr-[20px]"
      >
        <slot />
      </div>
