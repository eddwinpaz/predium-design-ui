...
<template>
  <div
    class="flex flex-col items-center justify-center text-center py-[48px] sm:py-[64px] px-[24px]"
  >
    <!-- Icon -->
    <div
      class="w-[64px] h-[64px] sm:w-[80px] sm:h-[80px] rounded-full bg-surface-input flex items-center justify-center mb-[20px] sm:mb-[24px]"
    >
      <slot name="icon">
        <svg
    ...
    <!-- Title -->
    <h3
      class="text-[18px] sm:text-[20px] font-semibold text-content-primary leading-[26px]"
    >
      {{ title }}
    </h3>
