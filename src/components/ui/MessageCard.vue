...
<template>
  ...
  >
    ...
    <!-- Content -->
    <div class="p-[24px]">
      <h3 class="text-[18px] font-bold text-content-primary leading-[24px]">
        {{ heading }}
      </h3>
      <p class="text-[14px] text-content-secondary mt-[6px] leading-[20px]">
        {{ description }}
      </p>
      <button
        v-if="buttonLabel"
  ...
  >
    <div class="flex items-center min-h-[120px]">
      ...
      <div class="flex-1 p-[24px]">
        ...
        <p class="text-[14px] opacity-85 mt-[4px] leading-[20px]">
          {{ description }}
        </p>
        <button
          v-if="buttonLabel"
