...
<template>
  <div
    class="bg-bg-primary border border-border rounded-xl p-5 relative overflow-hidden"
  >
    <div class="flex items-start justify-between">
      <div>
        <div class="text-3xl font-bold text-content-primary tracking-tight">
          {{ value }}
        </div>
    ...
    <div
      :class="['absolute bottom-0 left-0 right-0 h-[3px]', accentBarClass]"
    />
  </div>
</template>
