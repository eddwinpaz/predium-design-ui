...
const defaultIcons: Record<string, string> = {
  ...
  Carriers:
    "M8 7h8m-8 5h8M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z",
  Facilities:
...
<template>
  <nav
    :class="[
      ...
      isLight
        ? 'bg-surface text-content-primary border-r border-border'
  ...
  >
    ...
    <div class="flex items-center h-[52px] px-[14px] flex-shrink-0">
      <button
        :class="[
          'w-[32px] h-[32px] flex items-center justify-center rounded-[8px] transition-colors',
          isLight
      ...
      <template v-for="item in items" :key="item.label">
        ...
        <template v-if="item.children?.length">
            ...
            :class="[
              ...
              isGroupActive(item)
                ? isLight
                  ...
                  : 'text-white'
                : isLight
                  ? 'text-content-tertiary hover:text-content-primary hover:bg-surface-input'
          ...
          >
            ...
            <svg
              v-if="!isCollapsed"
              :class="[
                'w-[14px] h-[14px] transition-transform duration-200 flex-shrink-0',
          ...
          >
            <button
              ...
              :class="[
                ...
                child.active
                  ? isLight
                    ? 'text-content-primary bg-surface-input'
                    : 'text-white bg-[#333]'
                  : isLight
                    ? 'text-content-tertiary hover:text-content-primary hover:bg-surface-input'
                    : 'text-content-tertiary hover:text-white hover:bg-[#1a1a1a]',
        ...
        <template v-else>
          ...
          >
            ...
            <span v-if="!isCollapsed" class="text-[14px] truncate">{{
              item.label
            }}</span>
          </button>
        </template>
